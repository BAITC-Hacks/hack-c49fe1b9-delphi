...
**[Лендинг — понятное знакомство с продуктом](https://delphi-landing-green.vercel.app)** · **[Открыть рабочее демо](https://delphi-review-demo.vercel.app)**

Лендинг объясняет, как найти нового исполнителя обязанности, сверить исходные пункты и записать решение. В нём — реальные экраны продукта и интерактивный пример. Синтетические кейсы явно помечены; демо показывает сохранённые результаты без вызова модели.

Самостоятельный сайт находится в [`landing/`](landing/); запуск и настройка адреса демо — [`landing/RUN.md`](landing/RUN.md).

![Лендинг Delphi на большом экране](landing/docs/screenshots/landing-desktop.png)

<img src="landing/docs/screenshots/landing-mobile.png" alt="Лендинг Delphi на мобильном экране" width="280" />
...
**Быстрая проверка (демо: вариант А или https://delphi-review-demo.vercel.app):**
...
**Демо:** https://delphi-review-demo.vercel.app — сохранённые результаты, без сервера и модели (то же, что вариант А). Начните с «Новое сравнение» → «Показать анализ».
