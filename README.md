...
**Быстрая проверка (демо, вариант А):**

1. `/` → «Новое сравнение» → «Редакция 8 → редакция 9» → «Показать анализ».
...
Развёрнутой версии нет. Решение запускается локально по разделу 7. Самый быстрый путь — вариант А, демо без сервера.
