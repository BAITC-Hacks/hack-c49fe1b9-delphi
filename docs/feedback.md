...
| Separate demo/design work | [Demo README](../demo-frontend/README.md), [design](../demo-frontend/docs/design/DESIGN.md), [scenarios](../demo-frontend/docs/design/SCENARIOS.md), [UI prompts](../demo-frontend/docs/design/ASTRA-UI-PROMPTS.md). These do not prove a feature exists in the connected Next.js frontend; demo design remains a separate project phase. |
